...
export default function (server) {
   ...
   */
  server.post('http://localhost:8080/fcrepo/rest/submissions', () => {
   ...
   * Mock the response from fcrepo for creating a submission
   */
  server.post('https://pass.local/fcrepo/rest/submissions/**', () => {
    return new Response(201, {
      Location: 'https://pass.local/fcrepo/rest/submissions/6a/e3/c0/91/6ae3c091-e87e-4249-a744-72cb93415a95',
      'Content-Type': 'text/plain; charset=UTF-8'
    });
   ...
   */
  server.patch('https://pass.local/fcrepo/rest/submissions/**', () => {
   ...
   */
  server.post('http://localhost:8080/fcrepo/rest/submissionEvents', () => {
    return new Response(201, {
